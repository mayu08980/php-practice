...
echo $message;
// シングルクォーテーションで囲まれた文字列内では、変数や特殊文字がそのまま扱われ
// 数展開や特殊文字の解釈が不要な場合に使用するのが適切
// ダブルクォーテーションも文字列リテラルを表しますが、文字列内の変数や特殊文字が展開されるので
// 字列内で変数展開や特殊文字の解釈が必要な場合に使用するのが適切。
// 今回は特殊文字などはないのでシングルを使う方が望ましい
// string型
// Q2 四則演算
$x = 5;
$y = 4;
