...
// もし初期値が$i = 100の場合は$i = 100にすると100までの表示を1コずつ順番に
// 表示するようになるのでtic-tacのみの表示になる。今回は4の倍数は ticを表示=4で割ることができる
// 同様に5で割り切れる数はtac、4かつ5で割り切れるときは tic-tac と表示すると考えました
// Q2 多次元連想配列
$personalInfos = [
  [
      'name' => 'Aさん',
...
// 配列型（array）
// foreachのメリット→配列のキー、バリューがが自由に書き換え可能で
// 任意の者を入れることができる。また配列の最初の要素から順に取り出して
// 反復（ループ）処理することでバグを減らすこともできる
